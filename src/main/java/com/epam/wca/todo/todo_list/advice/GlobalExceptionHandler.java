package com.epam.wca.todo.todo_list.advice;

import com.epam.wca.todo.todo_list.error.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> resourceNotFoundException(NoResourceFoundException ex, WebRequest request) {
